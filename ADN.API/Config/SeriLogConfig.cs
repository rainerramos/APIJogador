    ...
    public class SeriLogConfig
    {
        ...
        private static bool CheckSourceContextEquals(LogEvent logEvent)
        {
            ...
            return source.ToString().Contains("Microsoft.EntityFrameworkCore.Infrastructure") ||
                   ...
                   source.ToString().Contains("Microsoft.AspNetCore.Hosting.Diagnostics") ||
                   source.ToString().Contains("Microsoft.AspNetCore.Mvc.Infrastructure.ControllerActionInvoker") ||
                   source.ToString().Contains("Microsoft.AspNetCore.Routing.EndpointMiddleware");
        }
    }
}
